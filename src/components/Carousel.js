...
export const Carousel = forwardRef(({}, ref) => {
    ...
    const renderImages = projectsData[activeProject].image?.map((image, index) => {
        ...
        return(
        <div key={index} style={{height: '50vh', width: '37.5vw', margin:'5px'}}>
            <img src={image} style={{
                position:"relative",
                display:'flex',
                height:'100%',
    ...
    return (
        <div ref={carouselContainer} style={{height:'50vh',width:'37.5vw', display:'flex', flexDirection:'row', position:'relative',}}>
